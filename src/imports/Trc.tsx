import svgPaths from "./svg-tu4soscoky";

function Group() {
  return (
    <div className="absolute inset-[0.01%_0.01%_-0.01%_54.22%]" data-name="Group">
      <div className="absolute inset-[-2.73%_-6.18%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 11 24">
          <g id="Group">
            <path d={svgPaths.p3c3ffe80} id="Vector" stroke="var(--stroke-0, #264769)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.19245" />
          </g>
        </svg>
      </div>
    </div>
...
function Group2() {
  return (
    <div className="absolute bottom-[3.2%] left-0 right-[53.47%] top-[1.21%]">
      <div className="absolute bottom-[-2.85%] left-0 right-[-6.08%] top-[-2.85%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 11 23">
          <g id="Group 18831">
            <path d={svgPaths.p28ab3000} id="Vector 91" stroke="var(--stroke-0, #264769)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.19245" />
            <circle cx="4.94938" cy="2.29173" id="Ellipse 345" r="1.09927" stroke="var(--stroke-0, #264769)" strokeWidth="1.19245" />
            <circle cx="3.59215" cy="7.94324" id="Ellipse 346" r="1.09927" stroke="var(--stroke-0, #264769)" strokeWidth="1.19245" />
            <circle cx="1.6955" cy="13.9569" id="Ellipse 347" r="1.09927" stroke="var(--stroke-0, #264769)" strokeWidth="1.19245" />
            <circle cx="4.94938" cy="17.7109" id="Ellipse 348" r="1.09927" stroke="var(--stroke-0, #264769)" strokeWidth="1.19245" />
          </g>
        </svg>
      </div>
    </div>
...
function Frame() {
  return (
    <div className="[grid-area:1_/_1] h-[21.876px] ml-0 mt-[11.44px] relative w-[21.086px]">
      <Group />
      <Group2 />
    </div>
  );
...
function Group1() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0">
      <Frame />
      <div className="[grid-area:1_/_1] h-[18.249px] ml-[10.49px] mt-0 relative w-[27.373px]" data-name="Vector">
        <div className="absolute inset-[-5.92%_-3.95%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 30 21">
            <path d={svgPaths.p308b9900} id="Vector" stroke="url(#paint0_linear_5_2405)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.16001" />
            <defs>
              <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_5_2405" x1="14.7436" x2="14.7436" y1="1.08" y2="19.329">
...
function Icon() {
  return (
    <div className="absolute inset-[17.4%_21.07%_17.39%_21.08%]" data-name="icon">
      <div className="absolute inset-[-1.01%_-1.14%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15 16">
          <g id="icon">
            <path d={svgPaths.p28a59b80} id="Vector" stroke="url(#paint0_linear_5_2407)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="0.316771" />
            <path d={svgPaths.p28a59b80} id="Vector_2" stroke="url(#paint1_linear_5_2407)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="0.316771" />
            <path d={svgPaths.p7bfc700} fill="url(#paint2_linear_5_2407)" id="Vector_3" />
          </g>
          <defs>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_5_2407" x1="1.98741" x2="12.9343" y1="13.4737" y2="3.27454">
            ...
            <linearGradient gradientUnits="userSpaceOnUse" id="paint1_linear_5_2407" x1="1.98741" x2="12.9343" y1="13.4737" y2="3.27454">
              <stop offset="0.1" stopColor="#BD1E35" />
              <stop offset="0.333333" stopColor="#8C3D5B" />
              <stop offset="0.520833" stopColor="#784A6A" />
              <stop offset="0.666667" stopColor="#61597C" />
            ...
            <linearGradient gradientUnits="userSpaceOnUse" id="paint2_linear_5_2407" x1="2.46821" x2="12.3884" y1="12.9714" y2="3.73348">
              <stop offset="0.1" stopColor="#BD1E35" />
              <stop offset="0.333333" stopColor="#8C3D5B" />
              <stop offset="0.520833" stopColor="#784A6A" />
              <stop offset="0.666667" stopColor="#61597C" />
...
function IconPlans() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="Icon/Plans">
      <Icon />
    </div>
  );
}
...
function PlanType() {
  return (
    <div className="bg-[#f0f4ff] box-border content-stretch flex h-[30px] items-center justify-between max-w-[135px] overflow-clip px-[8px] py-[4px] relative rounded-[4px] shrink-0 w-[135px]" data-name="Plan Type">
      <p className="basis-0 font-['Roboto:Medium',sans-serif] font-medium grow leading-[14px] min-h-px min-w-px relative shrink-0 text-[#004cc5] text-[12px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        Free
      </p>
      <IconPlans />
    </div>
...
function IconInfo() {
  return (
    <div className="relative shrink-0 size-[30px]" data-name="Icon/Info">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 30 30">
        <g id="Icon/Info">
          <g id="icon">
            <path d={svgPaths.p13144980} fill="var(--fill-0, #5B626E)" />
            <path clipRule="evenodd" d={svgPaths.p2864ec00} fill="var(--fill-0, #5B626E)" fillRule="evenodd" />
          </g>
        </g>
      </svg>
    </div>
...
function MarketplaceProtections() {
  return (
    <div className="h-[40px] relative shrink-0 w-full" data-name="Marketplace protections">
...
function ReleaseStatusBadge() {
  return (
    <div className="bg-[#ebe0fb] box-border content-stretch flex gap-[4px] h-[20px] items-center justify-center overflow-clip px-[8px] py-[4px] relative rounded-[4px] shrink-0 w-[44px]" data-name="Release status badge">
      <div className="flex flex-col font-['Roboto:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#641bc9] text-[12px] text-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
...
function ProtectionList() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="protection list">
...
function Plan1() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-[270px]" data-name="plan">
      <Header />
      <ProtectionList />
    </div>
  );
...
function IconInfo1() {
  return (
    <div className="relative shrink-0 size-[19px]" data-name="Icon/Info">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 19 19">
        <g id="Icon/Info">
          <g id="icon">
            <path d={svgPaths.p3dc0db00} fill="var(--fill-0, #5B626E)" />
            <path clipRule="evenodd" d={svgPaths.p3376f300} fill="var(--fill-0, #5B626E)" fillRule="evenodd" />
          </g>
        </g>
      </svg>
    </div>
...
function Title() {
  return (
    <div className="content-stretch flex gap-[4px] h-[19px] items-end relative shrink-0 w-full" data-name="title">
      ...
      <div className="basis-0 grow h-0 min-h-px min-w-px relative shrink-0" data-name="divider">
        <div className="absolute bottom-0 left-0 right-0 top-[-1px]" style={{ "--stroke-0": "rgba(237, 238, 240, 1)" } as React.CSSProperties}>
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 135 1">
            <line id="divider" stroke="var(--stroke-0, #EDEEF0)" strokeLinecap="round" x1="0.5" x2="134.5" y1="0.5" y2="0.5" />
          </svg>
        </div>
      </div>
    </div>
...
function SpeedInfo() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Speed Info">
      <div className="flex flex-col font-['Roboto:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#015ecb] text-[14px] text-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[16px] whitespace-pre" dir="auto">
          N/A
        </p>
      </div>
  ...
  return (
    <div className="basis-0 bg-[#f5f6f8] grow min-h-px min-w-px relative rounded-bl-[4px] rounded-br-[4px] shrink-0" data-name="info">
      <div className="flex flex-col justify-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex flex-col gap-[4px] items-start justify-center p-[20px] relative w-full">
          <SpeedInfo />
          <div className="flex flex-col font-['Roboto:Light',sans-serif] font-light justify-center leading-[0] relative shrink-0 text-[#264769] text-[12px] text-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
            <p className="leading-[14px] whitespace-pre" dir="auto">
              Purchased
            </p>
          </div>
...
function IconInfo2() {
  return (
    <div className="relative shrink-0 size-[14px]" data-name="Icon/Info">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
        <g clipPath="url(#clip0_5_2399)" id="Icon/Info">
          <g id="icon">
            <path d={svgPaths.p104f4a0} fill="var(--fill-0, #5B626E)" />
            <path clipRule="evenodd" d={svgPaths.p9faf500} fill="var(--fill-0, #5B626E)" fillRule="evenodd" />
          </g>
        </g>
        <defs>
...
function Usage() {
  return (
    <div className="basis-0 content-stretch flex flex-col gap-[8px] grow items-end min-h-px min-w-px relative shrink-0" data-name="Usage">
      <Status />
      <Content1 />
    </div>
  );
...
export default function Trc1() {
  return (
    <div className="bg-white relative rounded-[8px] size-full" data-name="TRC">
      <div aria-hidden="true" className="absolute border border-[#006064] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex gap-[30px] items-center p-[20px] relative size-full">
          <Plan1 />
          <Usage />
        </div>
      </div>
